...
def scrapeMAT1830():
    ...
    # Now we have the links we want, and we need to download them to the appropriate directory. To do this, we have to
    ...
    temp_driver = webdriver.Chrome('C:/Users/Liam/Drivers/chromedriver.exe', options=temp_options)
